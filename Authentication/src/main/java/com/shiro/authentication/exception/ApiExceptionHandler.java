...
public class ApiExceptionHandler {
  ...
  public ResponseEntity<Map<String, Object>> api(ApiException ex, HttpServletRequest req) {
    log.warn(
        "API error method={} path={} code={} message={}",
        req.getMethod(),
        req.getRequestURI(),
        ex.error().name(),
        ex.getMessage());
  ...
  public ResponseEntity<Map<String, Object>> malformed(Exception ex, HttpServletRequest req) {
    log.warn("Malformed request method={} path={}", req.getMethod(), req.getRequestURI());
  ...
  public ResponseEntity<Map<String, Object>> unauthenticated(
    ...
    log.warn("Unauthenticated request method={} path={}", req.getMethod(), req.getRequestURI());
  ...
  public ResponseEntity<Map<String, Object>> forbidden(
    ...
    log.warn("Forbidden request method={} path={}", req.getMethod(), req.getRequestURI());
  ...
  public ResponseEntity<Map<String, Object>> notFound(Exception ex, HttpServletRequest req) {
    log.warn("Unsupported request method={} path={}", req.getMethod(), req.getRequestURI());
