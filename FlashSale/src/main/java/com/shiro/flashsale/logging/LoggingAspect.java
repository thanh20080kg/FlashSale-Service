package com.shiro.flashsale.logging;
...
public class LoggingAspect {
  ...
  @Around("within(com.shiro.flashsale.controller..*)")
  ...
  @Around(
      "execution(public * com.shiro.flashsale..*(..))"
          + " && !within(com.shiro.flashsale.config..*)"
          + " && !within(com.shiro.flashsale.logging..*)"
          + " && !within(com.shiro.flashsale.controller..*)")
